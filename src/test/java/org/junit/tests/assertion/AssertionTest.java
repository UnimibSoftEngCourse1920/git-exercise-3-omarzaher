...
//  }
    ...
    public void greaterThan() {
        ...
        assertGreaterThan(3,2, comparatorInt);
        
        Comparator<Float> comparatorFloat = new Comparator<Float>() {
        ...
        assertGreaterThan(3.1f,2.2f, comparatorFloat);
        ...
        assertGreaterThan(3.1, 2.2, comparatorDouble);
        
        Comparator<Character> comparatorCharacter = new Comparator<Character>() {
